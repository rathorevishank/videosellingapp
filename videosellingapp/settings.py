"""
Django settings for videosellingapp project.
...
SECRET_KEY = 'django-insecure-ie*i(1pf5u*y%!n4uerl!swc3f-j-8t2x!b4(=qq!vc-^_a0^y'
...
ROOT_URLCONF = 'videosellingapp.urls'
...
WSGI_APPLICATION = 'videosellingapp.wsgi.application'
